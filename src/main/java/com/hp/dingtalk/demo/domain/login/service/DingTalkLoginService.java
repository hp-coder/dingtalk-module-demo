...
public class DingTalkLoginService {
    ...
    public OapiV2UserGetResponse.UserGetResponse queryDingDing(DingTalkLoginRequest request) {
        ...
        //新版免登录
            ...
            final String me = "me";
            final GetUserTokenResponseBody userToken = new DingLoginHandler(app).getUserToken(request.getAuthCode(), IDingLoginHandler.GrantType.authorization_code);
            final GetUserResponseBody contactUserResponse = new DingContactHandler(app).personalContactInfo(userToken.getAccessToken(), me);
